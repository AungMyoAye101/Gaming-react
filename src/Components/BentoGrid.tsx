...
const BentoGrid = () => {
  return (
    <section className="grid grid-cols-2 gap-4 md:gap-7 h-[135vh] grid-rows-3 w-full  ">
      <BentoTilt className=" special-font  bento-tilt_1 row-span-1 md:row-span-2 md:col-span-1">
        <BentoCard
      ...
      <BentoTilt className="bento-tilt_1 ms-12 md:ms-0 row-span-1 md:col-span-1">
        <BentoCard
